...
public class DbManager {
	...
	public static void setDbConnection()
			throws SQLException, ClassNotFoundException, AddressException, MessagingException {
		try {
	...
	public static void setMysqlDbConnection()
		...
		try {
			...
			conn = DriverManager.getConnection(TestConfig.dbConnectionUrl, TestConfig.mysqluserName,
